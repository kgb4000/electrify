          ...
          <div className="grid gap-x-6 md:grid-cols-3 lg:gap-x-12 my-20 sm:px-6">
            <div className="mb-12 md:mb-0">
              ...
              <p className="mb-4">
                ...
                able to repair the issue in a timely manner. Would highly
            ...
            <div className="mb-12 md:mb-0">
              ...
              <p className="mb-4">
                ...
                found that company with Electrify Electric, LLC. It's also a
                great that everyone is friendly, knowledgeable, and communicates
                in layman's terms.
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 96 960 960"
            ...
            <div className="mb-0">
              ...
              <p className="mb-4">
                ...
                outlet) and got everything working like new! I trust them with
                keeping my home functional and safe! Thank you!
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 96 960 960"
                  className="inline-block w-6"
