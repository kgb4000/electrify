...
const electricalServices = () => {
  return (
    <>
      <Header />
      <div className="bg-[url('https://images.pexels.com/photos/942316/pexels-photo-942316.jpeg?auto=compress&cs=tinysrgb&w=800')] bg-center bg-no-repeat bg-cover h-40 mt-20"></div>
      <div>
        ...
        <div className="container px-6 max-w-7xl mx-auto">
          <div>
            <div className="py-20">
              ...
              <div className="grid lg:grid-cols-2 gap-10 my-10 lg:my-20 text-lg">
                <div>
